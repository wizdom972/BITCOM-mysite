		...
		<div id="content">
			<div id="board">
				...
				<form id="search_form"
					  ...
					  method="get">
					<input type="text" id="keyword" name="kwd" value="${keyword}" />
				...
				<div class="pager">
					<ul>
						...
						<c:if test="${currentPage > 1}">
							<li>
								<a href="${pageContext.request.contextPath}/board?p=${currentPage - 1}&kwd=${keyword}">
									◀
								</a>
							</li>
						</c:if>
						...
						<c:forEach begin="${startPage}" end="${endPage}" var="i">
							<c:choose>
								...
								<c:otherwise>
									<li>
										<a href="${pageContext.request.contextPath}/board?p=${i}&kwd=${keyword}">
											${i}
										</a>
									</li>
								</c:otherwise>
